...
// Siluetas de continentes extraídas de tierra.html.
const CONTINENTES = [
...
// Ícono de "sitio en vivo": Tierra con continentes fijos + pin de pulso
// animado encima. Usado en lugar del ícono genérico para "Datos del sitio".
// `size` es el diámetro final en px; todo lo demás está en em y escala solo.
export function EarthLoader({ size = 32, pulso = true }) {
  return (
    <div className="earth-wrapper" style={{ fontSize: size / 7.5 }}>
      <div className="earth">
      ...
      {pulso && <div className="pulse-loader" />}
    </div>
  );
}
